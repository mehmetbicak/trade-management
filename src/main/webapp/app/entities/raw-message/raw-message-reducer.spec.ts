...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_RAWMESSAGE_LIST actions', async () => {
    ...
    it('dispatches FETCH_RAWMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_RAWMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_RAWMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_RAWMESSAGE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_RAWMESSAGE actions', async () => {
      const expectedActions = [
        {
